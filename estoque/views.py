...
def add_produto(request):
    if request.method == "GET":
        ...
        if nome or categoria or preco_min or preco_max:
            ...
            if nome:
                 produto = produto.filter(nome__icontains=nome)
            ...
            produto = produto.filter(preco_venda__gte=preco_min).filter(preco_venda__lte=preco_max)


        categorias = Categoria.objects.all() 
        return render(request, 'add_produto.html', {'categorias': categorias, 'produto': produto})
